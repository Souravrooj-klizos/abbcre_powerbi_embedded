      ...
      >
        ...
        {mapVisible && (
          <>
            ...
            {/* Overlay mode — full cover over the report area */}
            {isOverlay && (
              <div
                className="absolute inset-0 z-20 bg-white flex flex-col"
              >
                <div className="flex items-center justify-between px-3 py-1.5 bg-gray-100 border-b border-gray-200 text-xs text-gray-600 shrink-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">ArcGIS Map</span>
                    <span className="text-gray-400">|</span>
                    <span>Click a feature to filter the report</span>
                  </div>
                  <button
                    onClick={() => setMapPosition("right")}
                    className="px-2 py-0.5 bg-white border border-gray-300 rounded text-gray-600 hover:bg-gray-50 transition text-xs"
                    title="Exit overlay — switch to split view"
                  >
                    ✕ Exit Overlay
                  </button>
                </div>
